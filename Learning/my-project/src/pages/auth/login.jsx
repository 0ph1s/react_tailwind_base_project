        ...
        <>
            <main className='bg-slate-900 w-screen h-screen flex justify-center items-center'>
                <section className='flex flex-col gap-6 items-center'>
                    ...
                    <button className='bg-[blueviolet] hover:bg-[#892be2a3] transition-colors duration-200 text-white font-semibold p-2 rounded-md w-64'>Login</button>
                    <p className='text-white font-semibold'>Forgot your password?
